Make sure you have .env file with the necessary credentials to be able to send an email, as well as the polygon api key. (Refer to the .env.example file in src/)
